...
const Users = (props: any) => <svg {...props} xmlns="http://www.w3s.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>;
...
const MapPage = () => {
  ...
  // 동네 카드 클릭 핸들러: 쿼리 파라미터 대신 경로 변수(Path Variable) 사용
  const handleSelectNeighborhood = (id: string) => {
    // '/board/[id]' 형식의 경로로 이동합니다. 예: /board/gangnam-gu
