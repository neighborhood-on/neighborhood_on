                ...
                {features.map((feature, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="h-[220px] flex flex-col justify-end mb-10 w-full max-w-6xl mx-auto px-4">
                                {/* Small Label */}
                                ...
                                {/* Sub Description */}
                                <p className="text-gray-500 text-lg md:text-xl font-medium tracking-wide h-[30px] flex items-center justify-center">
                                    {feature.desc}
                                </p>
                            </div>
